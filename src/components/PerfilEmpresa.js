                ...
                <div class="col-12">
                    ...
                    <form class="file-upload">
                        <div class="row mb-5 gx-5">
                            <div class="col-xxl-8 mb-5 mb-xxl-0">
                                <div class="bg-secondary-soft px-4 py-5 rounded">
                                    <div class="row g-3">
                                        <h4 class="mb-4 mt-0">Detalles de Empresa</h4>
                                        <div class="col-md-6">
                                            <label class="form-label">Nombre Fantasia *</label>
                                            <input type="text" class="form-control" placeholder="" aria-label="First name" value="Thorben"/>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Razon Social *</label>
                                            <input type="text" class="form-control" placeholder="" aria-label="Last name" value="Thorben SPA"/>
                                        </div>
                            ...
                            <div class="col-xxl-4">
                                <div class="bg-secondary-soft px-4 py-5 rounded">
                                    <div class="row g-3">
                                        <h4 class="mb-4 mt-0">Logo Empresa</h4>
                        ...
                        <div class="gap-3 d-md-flex justify-content-md-end text-center">
                            <button type="button" class="btn btn-danger btn-lg">Eliminar Perfil Empresa</button>
                            <button type="button" class="btn btn-primary btn-lg">Actualizar Perfil Empresa</button>
                        </div>
                    </form> 
                </div>
            </div>
