            ...
            <div className='container shadow-lg p-3 mb-5 bg-white rounded  mt-5'>
                <div className='row '>
                    <div className='col mt-4'>
                        ...
                        />
                        <input className='input mt-3 w-100'
                            type='text'
                ...
                <div className='row'>
                    <div className='col'>
                        <p className='text-center mb-2'>Si eres empresa y quieres contratar nuestros servicios</p>
                        <button type='button' className='btn btn-success w-100 mb-4'>Contactar</button>
                    </div>
                </div>
            </div>
        </div>
