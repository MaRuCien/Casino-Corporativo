...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/workspace/Casino-Corporativo/.venv'
    let bin = 'bin'
    let path-sep = ':'
    ...
    let virtual-prompt = if ('Casino-Corporativo' == '') {
...
alias deactivate = source '/workspace/Casino-Corporativo/.venv/bin/deactivate.nu'
